...
$sql2 = "SELECT empresas.id, empresas.empresaNome, empresas.empresaTel, empresas.empresaEmail, empresas.empresaCidade, empresas.empresaEstado, empresas.empresaCep, segmento.segmentoNome
FROM empresas
INNER JOIN segmento ON empresas.idSegmento = segmento.id
ORDER BY empresas.id ASC";

$query = $conecta->query($sql2); // RODA A CONSULTA

$abrir  = fopen( "empresa.txt" , "w+" );
