 ...
 */
// define("HOSTNAME", "localhost"); 		// The host you want to connect to. 
// define("USERS", "admin"); 				// The database username. 
// define("PASSWORD", "rf346737"); 		// The database password. 
// define("DATABASE", "secure_login");     // The database name.

define("HOSTNAME", "localhost"); 		// The host you want to connect to. 
define("USERS", "root"); 				// The database username. 
define("PASSWORD", "root"); 		// The database password. 
define("DATABASE", "zafiro");     // The database name.
